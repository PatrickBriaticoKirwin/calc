...
function performCalculations() {
    ...
    var p1BattleState = { field: p1field, lastMove: undefined, userParty: [] };
    var p2BattleState = { field: p2field, lastMove: undefined, userParty: [] };
    ...
    for (var i = 0; i < 4; i++) {
        ...
        try {
            result.rawDesc.aiScore = calc.calcMoveScore(p1.moves[i], p1, p2, p1BattleState);
        } catch (e) {
            result.rawDesc.aiScore = 0;
        }
        ...
        try {
            result.rawDesc.aiScore = calc.calcMoveScore(p2.moves[i], p2, p1, p2BattleState);
        } catch (e) {
            result.rawDesc.aiScore = 0;
        }
